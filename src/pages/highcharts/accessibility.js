...
(function(b) {
  ...
  function x(b, r, n, q) {
    b.hasOwnProperty(r) || (b[r] = q.apply(null, n), "function" === typeof CustomEvent && window.dispatchEvent(new CustomEvent("HighchartsModuleLoaded", {
      detail: {
        path: r,
        module: b[r]
      }
  ...
  x(b, "Accessibility/Utils/HTMLUtilities.js", [b["Core/Globals.js"], b["Core/Utilities.js"]], function(b, r) {
    function n(b) {
      if ("function" === typeof w.MouseEvent) return new w.MouseEvent(b.type, b);
      if (m.createEvent) {
        const l = m.createEvent("MouseEvent");
        if (l.initMouseEvent) return l.initMouseEvent(b.type, b.bubbles, b.cancelable, b.view || w, b.detail, b.screenX, b.screenY, b.clientX, b.clientY, b.ctrlKey, b.altKey, b.shiftKey, b.metaKey, b.button, b.relatedTarget), l
      }
      return q(b.type)
    }
    ...
    function q(b, g, h) {
      ...
      return "function" === typeof w.MouseEvent ? new w.MouseEvent(b, {
        bubbles: !0,
        cancelable: !0,
        composed: !0,
        button: 0,
        ...
        clientX: g.x,
        clientY: g.y
      }) : m.createEvent && (h = m.createEvent("MouseEvent"), h.initMouseEvent) ? (h.initMouseEvent(b, !0, !0, w, "click" === b ? 1 : 0, g.x, g.y, g.x, g.y, !1, !1, !1, !1, 0, null), h) : {
        type: b
      }
    }
    const {
      ...
      css: v
    } = r, y = w.EventTarget && new w.EventTarget || "none";
    return {
      addClass: function(b, g) {
        b.classList ? b.classList.add(g) :
      ...
      cloneTouchEvent: function(b) {
        ...
        if ("function" === typeof w.TouchEvent) return l = new w.TouchEvent(b.type, {
            touches: l(b.touches),
          ...
          b.defaultPrevented && l.preventDefault(), l;
        l = n(b);
        l.touches = b.touches;
      ...
      removeClass: function(b, g) {
        b.classList ? b.classList.remove(g) : b.className = b.className.replace(new RegExp(g, "g"), "")
      },
  ...
  x(b, "Accessibility/A11yI18n.js", [b["Core/FormatUtilities.js"],
    b["Core/Utilities.js"]
  ], function(b, r) {
    const {
      format: n
    ...
    (function(b) {
      function y(a, c) {
        ...
        if (-1 < d) {
          ...
          a = "";
          if (c = q(f[0], c))
            for (d = isNaN(d) ? c.length : d, d = 0 > d ? c.length + d : Math.min(d, c.length), f = 0; f < d; ++f) a += A + c[f] + e;
          return a.length ? a : ""
        }
        if (-1 < e) {
          A = a.slice(e).indexOf(")") +
        ...
        return -1 < f ? (e = a.substring(0, f), a = Number(a.substring(f + 1, b)), c = q(e, c), !isNaN(a) && c && (0 > a ? (A = c[c.length + a], "undefined" === typeof A && (A = c[0])) : (A = c[a], "undefined" === typeof A && (A = c[c.length - 1]))), "undefined" !== typeof A ? A : "") : "{" + a + "}"
      }
      ...
      function l(a, c, d) {
        const e = (a, f) => {
          ...
          f = [];
        let b, A, h = 0;
        do b = e(a, h), A = a.substring(h, b && b.begin - 1), A.length && f.push({
          value: A,
          type: "constant"
        }), b && f.push({
          value: b.statement,
          type: "statement"
        }), h = b ? b.end + 1 : h + 1; while (b);
        f.forEach(a => {
          "statement" === a.type && (a.value = y(a.value, c))
        });
        return n(f.reduce((a, f) => a + f.value, ""), c, d)
      }
  ...
  x(b, "Accessibility/Utils/ChartUtilities.js", [b["Core/Globals.js"], b["Accessibility/Utils/HTMLUtilities.js"], b["Core/Utilities.js"]], function(b, r, n) {
    function q(a, f) {
      const c = f.type,
        e = a.hcEvents;
      g.createEvent && (a.dispatchEvent || a.fireEvent) ? a.dispatchEvent ? a.dispatchEvent(f) : a.fireEvent(c, f) : e && e[c] ? d(a, c, f) : a.element && q(a.element, f)
    }
    ...
    function l(a, c) {
      ...
      c !== a.renderTo &&
        c.parentNode && c.parentNode !== g.body && (Array.prototype.forEach.call(c.parentNode.childNodes, function(a) {
    ...
    return {
      ...
      getChartTitle: function(a) {
        return h(a.options.title.text || a.langFormat("accessibility.defaultChartTitle", {
          chart: a
        }))
      },
      getAxisDescription: function(a) {
        return a && (a.userOptions && a.userOptions.accessibility &&
          a.userOptions.accessibility.description || a.axisTitle && a.axisTitle.textStr || a.options.id || a.categories && "categories" || a.dateTime && "Time" || "values")
      },
      getAxisRangeDescription: function(a) {
        ...
        return c.accessibility && "undefined" !== typeof c.accessibility.rangeDescription ? c.accessibility.rangeDescription : a.categories ? (c = a.chart, a = a.dataMax && a.dataMin ? c.langFormat("accessibility.axis.rangeCategories", {
          ...
          }) : "", a) : !a.dateTime || 0 !== a.min && 0 !== a.dataMin ?
          w(a) : m(a)
      },
      ...
      scrollToPoint: function(c) {
        ...
        if ((f = e && e.scrollbar) &&
          ...
          if (a(e.dataMin) && a(e.dataMax)) {
            ...
            c = (e.toPixels(c["xAxis" === e.coll ? "x" : "y"] || 0) - h) / (l - h)
          } else c = 0;
  ...
  x(b, "Accessibility/AccessibilityComponent.js",
    [b["Accessibility/Utils/ChartUtilities.js"], b["Accessibility/Utils/DOMElementProvider.js"], b["Accessibility/Utils/EventProvider.js"], b["Accessibility/Utils/HTMLUtilities.js"], b["Core/Utilities.js"]],
    function(b, r, n, q, m) {
      const {
  ...
  x(b, "Accessibility/KeyboardNavigationHandler.js", [b["Core/Utilities.js"]], function(b) {
    ...
    class n {
      ...
      run(b) {
        ...
        q ? n = q[1].call(this, m, b) : 9 === m && (n = this.response[b.shiftKey ?
          "prev" : "next"]);
        return n
      }
    }
  ...
  x(b, "Accessibility/Components/ContainerComponent.js", [b["Accessibility/AccessibilityComponent.js"], b["Accessibility/KeyboardNavigationHandler.js"], b["Accessibility/Utils/ChartUtilities.js"], b["Core/Globals.js"], b["Accessibility/Utils/HTMLUtilities.js"]], function(b, r, n, q, m) {
    const {
      unhideChartElementFromAT: w,
      getChartTitle: v
    } = n, {
      doc: y
    } = q, {
    ...
    class g extends b {
      ...
      handleSVGTitleElement() {
        const b = this.chart,
          ...
          c = l(b.langFormat("accessibility.svgContainerTitle", {
            chartTitle: v(b)
          }));
        if (c.length) {
          const d = this.svgTitleElement = this.svgTitleElement || y.createElementNS("http://www.w3.org/2000/svg", "title");
          d.textContent = c;
          d.id = a;
      ...
      setSVGContainerLabel() {
        ...
        b.renderer.box &&
          a.length && b.renderer.box.setAttribute("aria-label", a)
      }
      ...
      setRenderToAttrs() {
        ...
        c && (b.renderTo.setAttribute("role", a ? "region" : "group"), b.renderTo.setAttribute("aria-label", c))
      }
  ...
  x(b, "Accessibility/FocusBorder.js", [b["Core/Renderer/SVG/SVGLabel.js"], b["Core/Utilities.js"]],
    function(b, r) {
      const {
        addEvent: n,
        pick: q
      ...
      (function(m) {
        ...
        function y(a, c) {
          ...
          (c = c || a.element) && c.focus && (c.hcEvents && c.hcEvents.focusin || n(c, "focusin", function() {}), c.focus(), b.hideBrowserFocusOutline &&
        ...
        function g(a, c) {
          ...
          B = (B ?
            !g : g) ? Math.abs(B || g || 1) : (Math.abs(B || 1) + Math.abs(g || 1)) / 2;
          ...
          if ("text" === this.element.nodeName || t) {
            ...
            if (t) var p = {
              ...
              var E = p = 0;
              "middle" === this.attr("text-anchor") ? p = E = .5 : this.rotation ? p = .25 : E = .75;
              p = {
                x: p,
                y: E
              }
            ...
            t && a &&
              (t = u, u = k, k = t, isNaN(E) || (g = E - d.height * p.x - f), isNaN(c) || (z = c - d.width * p.y - f))
          }
          this.focusBorder = this.renderer.rect(g, z, u, k, parseInt((c && c.r || 0).toString(), 10) / B).addClass("highcharts-focus-border").attr({
            zIndex: 99
          }).add(e);
        ...
        m.compose = function(c, b) {
          r.pushUnique(d, c) && (c = c.prototype, c.renderFocusBorder = w, c.setFocusToElement = y);
          r.pushUnique(d, b) && (b = b.prototype, b.addFocusBorder = g, b.removeFocusBorder = a)
        }
      })(m || (m = {}));
      return m
    });
  x(b, "Accessibility/Utils/Announcer.js", [b["Core/Renderer/HTML/AST.js"], b["Accessibility/Utils/DOMElementProvider.js"], b["Core/Globals.js"], b["Accessibility/Utils/HTMLUtilities.js"], b["Core/Utilities.js"]], function(b, r, n, q, m) {
    const {
      doc: w
    } = n, {
      addClass: v,
      visuallyHideElement: y
    } = q, {
      attr: l
    } = m;
    class g {
  ...
  x(b, "Accessibility/Components/AnnotationsA11y.js",
    ...
    function(b) {
      ...
      function q(b) {
        var l = b.options && b.options.accessibility && b.options.accessibility.description;
        if (l) return l;
        l = b.chart;
        const g = n(b),
          h = b.points.filter(a => !!a.graphic).map(a => {
      ...
      const {
        escapeStringForHTML: w,
        stripHTMLTagsFromString: v
      } = b;
      return {
        getAnnotationsInfoHTML: function(b) {
          const l = b.annotations;
          return l && l.length ? `<ul style="list-style-type: none">${m(b).join(" ")}</ul>` : ""
        },
  ...
  x(b, "Accessibility/Components/InfoRegionsComponent.js", [b["Accessibility/A11yI18n.js"],
    b["Accessibility/AccessibilityComponent.js"], b["Accessibility/Utils/Announcer.js"], b["Accessibility/Components/AnnotationsA11y.js"], b["Core/Renderer/HTML/AST.js"], b["Accessibility/Utils/ChartUtilities.js"], b["Core/FormatUtilities.js"], b["Core/Globals.js"], b["Accessibility/Utils/HTMLUtilities.js"], b["Core/Utilities.js"]
    ...
    function h(a, b) {
      ...
      if ("map" === c) return p.mapTitle ? a.langFormat("accessibility.chartTypes.mapTypeDescription", p) : a.langFormat("accessibility.chartTypes.unknownMap", p);
      if (1 < a.types.length) return a.langFormat("accessibility.chartTypes.combinationChart", p); {
        ...
        a = (a.langFormat("accessibility.chartTypes." + b + d, p) ||
          a.langFormat("accessibility.chartTypes.default" + d, p)) + (c ? " " + c : "")
      }
      return a
    }
    const {
    ...
    class t extends r {
      ...
      setLinkedDescriptionAttrs() {
        ...
        a && (a.setAttribute("aria-hidden", "true"), K(a, "highcharts-linked-description"))
      }
      updateScreenReaderSection(a) {
        ...
        d ? (this.setScreenReaderSectionAttribs(k, a), m.setElementHTML(p, d), k.appendChild(p), c.insertIntoDOM(k, b), b.styledMode ? K(p, "highcharts-visually-hidden") : z(p), f(b, p), c.afterInserted && c.afterInserted()) : (k.parentNode &&
          k.parentNode.removeChild(k), c.element = null)
      }
      ...
      defaultBeforeChartFormatter() {
        ...
        const f = c.sonify && c.options.sonification && c.options.sonification.enabled,
          ...
          z = a(c),
          B = c.langFormat("accessibility.screenReaderSection.annotations.heading", {
            chart: c
          });
        k = {
      ...
      getTypeDescriptionText() {
        const a = this.chart;
        return a.types ? a.options.accessibility.typeDescription || h(a, a.types) : ""
      }
      ...
      getAxesDescription() {
        ...
        var b = function(b, c) {
            b = a[b];
            return 1 < b.length || b[0] && k(b[0].options.accessibility && b[0].options.accessibility.enabled, c)
          },
      ...
      getAxisDescriptionText(a) {
        const b = this.chart,
          k = b[a];
        return b.langFormat("accessibility.axis." + a + "Description" + (1 < k.length ? "Plural" : "Singular"), {
          chart: b,
    ...
    function(b, r, n, q, m, w) {
      ...
      class h extends n {
        ...
        a.compose = function(a) {
          r.pushUnique(B, a) && (a = b.prototype, a.hideExportMenu =
            d, a.highlightExportItem = e, a.highlightLastExportItem = f, a.showExportMenu = c)
        }
      })(h || (h = {}));
      return h
    });
  x(b, "Accessibility/KeyboardNavigation.js", [b["Core/Globals.js"], b["Accessibility/Components/MenuComponent.js"], b["Core/Utilities.js"], b["Accessibility/Utils/EventProvider.js"], b["Accessibility/Utils/HTMLUtilities.js"]], function(b, r, n, q, m) {
    const {
      doc: w,
      win: v
    } = b, {
    ...
    class a {
      ...
      init(a, b) {
        ...
        ["mouseup", "touchend"].forEach(a => c.addEvent(w, a, a => this.onMouseUp(a)));
  ...
  x(b, "Accessibility/Components/LegendComponent.js", [b["Core/Animation/AnimationUtilities.js"],
    ...
    function g(a, b) {
      ...
      for (const k of ["group", "label", "symbol"])(b = (b = c[k]) && b.element || b) && d(b, a ? "mouseover" : "mouseout")
    }
    const {
      animObject: h
    } = b, {
    ...
    class F extends m {
      ...
      init() {
        ...
        this.addEvent(n, "afterRender", function() {
          this.chart === a.chart && this.chart.renderer && a.recreateProxies() && B(() => a.proxyProvider.updateGroupProxyElementPositions("legend"), h(f(this.chart.renderer.globalAnimation,
            !0)).duration)
        })
      }
      updateLegendItemProxyVisibility() {
        ...
        (b.allItems || []).forEach(k => {
          if (k.a11yProxyElement) {
            ...
            var G = !1;
            f = k.legendItem || {};
            e && (k = f.pageIx || 0, e = f.y || 0, G = f.label ? Math.round(f.label.getBBox().height) : 0, G = e + G - b.pages[k] > d || k !== c - 1);
            G ? a.styledMode ? H(p, "highcharts-a11y-invisible") : p.style.visibility = "hidden" : (x(p, "highcharts-a11y-invisible"), p.style.visibility =
              "")
          }
        })
      }
      ...
      highlightAdjacentLegendPage(a) {
        ...
        if (0 < a && a <= d.length) {
          d = 0;
          for (const k of c.allItems)((k.legendItem || {}).pageIx || 0) + 1 === a && (c = b.highlightLegendItem(d)) && (this.highlightedLegendItemIx = d), ++d
        }
      }
      ...
      recreateProxies() {
        ...
        b = b && c && c.contains(b);
        this.removeProxies();
        return l(this.chart) ? (this.addLegendProxyGroup(), this.proxyLegendItems(), this.updateLegendItemProxyVisibility(), this.updateLegendTitle(), b && this.chart.highlightLegendItem(this.highlightedLegendItemIx), !0) : !1
      }
      removeProxies() {
      ...
      function b(a) {
        ...
        const k = b[a];
        var d = k.legendItem || {};
        return k ? (e(c) && b[c] && g(!1, b[c]), b = this.legend, a = (b.allItems[a].legendItem || {}).pageIx, c = b.currentPage, "undefined" !== typeof a && a + 1 !== c && b.scroll(1 + a - c), d = d.label, a = k.a11yProxyElement && k.a11yProxyElement.buttonElement, d && d.element && a && this.setFocusToElement(d, a), g(!0, k), !0) : !1
      }
  ...
  x(b, "Accessibility/Components/SeriesComponent/SeriesDescriber.js", [b["Accessibility/Components/AnnotationsA11y.js"], b["Accessibility/Utils/ChartUtilities.js"], b["Core/FormatUtilities.js"], b["Accessibility/Utils/HTMLUtilities.js"], b["Core/Utilities.js"]], function(b, r, n, q, m) {
    function w(a) {
      const b = a.index;
      return a.series &&
        a.series.data && J(b) ? t(a.series.data, function(a) {
    ...
    function g(a, b) {
      ...
      c = c.tooltipOptions || {};
      k = k.options.lang;
      return p(b) ? z(b, d.valueDecimals || a.valueDecimals || c.valueDecimals || -1, k.decimalPoint, k.accessibility.thousandsSep || k.thousandsSep) : b
    }
    ...
    function d(a) {
      ...
      d = E(d.xAxis && d.xAxis.options.accessibility && d.xAxis.options.accessibility.enabled, !f.angular && "flowmap" !== d.type);
      if (d) {
        var p = a.series;
        var t = p.chart;
        var G = p.options.accessibility && p.options.accessibility.point || {},
          u = t.options.accessibility.point || {};
        (p = p.xAxis && p.xAxis.dateTime) ? (p = p.getXDateFormat(a.x || 0, t.options.tooltip.dateTimeLabelFormats), G = G.dateFormatter && G.dateFormatter(a) || u.dateFormatter && u.dateFormatter(a) || G.dateFormat || u.dateFormat || p, t = t.time.dateFormat(G, a.x || 0, void 0)) : t = void 0;
        G =
          (a.series.xAxis || {}).categories && J(a.category) && ("" + a.category).replace("<br/>", " ");
      ...
      t = J(a.index) ? a.index + 1 : ""; {
        ...
        var h = u.chart.options.accessibility.point || {},
          l = u.chart.options.accessibility && u.chart.options.accessibility.point || {};
        const b = u.tooltipOptions || {};
        p = l.valuePrefix || h.valuePrefix || b.valuePrefix || "";
        h = l.valueSuffix || h.valueSuffix || b.valueSuffix || "";
        l = g(a, a["undefined" !== typeof a.value ?
          "value" : "y"]);
        u = a.isNull ? u.chart.langFormat("accessibility.series.nullPointValue", {
          point: a
        }) : u.pointArrayMap ? c(a, p, h) : p + l + h
      }
      f = F(e, {
        point: a,
        index: t,
      ...
      k = d.length ? k.langFormat("accessibility.series.pointAnnotationsDescription", t) : "";
      ...
      (b || c) && a.points.forEach(c => {
        ...
        if (!(e = c.graphic && c.graphic.element)) {
          ...
          if (e = c.isNull && !p && e) {
            ...
            t = t ? {
              x: E(c.plotX, t.plotX, 0),
              y: E(c.plotY, t.plotY, 0)
            } : {
              x: E(c.plotX, 0),
              y: E(c.plotY, 0)
            };
        ...
        e && (c.isNull && !f ? e.setAttribute("aria-hidden", !0) : (e.setAttribute("tabindex", "-1"), a.chart.styledMode || (e.style.outline = "none"), b && !p ? (t = c.series, p = t.chart.options.accessibility.point || {},
          t = t.options.accessibility && t.options.accessibility.point || {}, c = k(t.descriptionFormatter && t.descriptionFormatter(c) || p.descriptionFormatter && p.descriptionFormatter(c) || d(c)), e.setAttribute("role", "img"), e.setAttribute("aria-label", c)) : e.setAttribute("aria-hidden", !0)))
      })
    }
    ...
    function f(b) {
      ...
      k = 1 < k.length ? "Combination" :
        "";
      u = c.langFormat("accessibility.series.summary." + b.type + k, u) || c.langFormat("accessibility.series.summary.default" + k, u);
      f = (f("yAxis") ? " " + t + "." : "") + (f("xAxis") ? " " + p + "." : "");
      p = E(b.options.accessibility && b.options.accessibility.descriptionFormat, c.options.accessibility.series.descriptionFormat, "");
      return F(p, {
        seriesDescription: u,
      ...
      describeSeries: function(a) {
        ...
        if (d) {
          ...
          x(b, d); {
            ...
            b = !(b.options3d && b.options3d.enabled && c) && (c || p || k || v(a))
          }
          b ? (b = a.chart.options.accessibility, c = b.landmarkVerbosity, (a.options.accessibility || {}).exposeAsGroupOnly ? d.setAttribute("role", "img") : "all" === c ? d.setAttribute("role", "region") : d.setAttribute("role", "group"), d.setAttribute("tabindex", "-1"), a.chart.styledMode || (d.style.outline = "none"), d.setAttribute("aria-label", k(b.series.descriptionFormatter && b.series.descriptionFormatter(a) || f(a)))) : d.removeAttribute("aria-label")
        }
      }
    }
  });
  x(b, "Accessibility/Components/SeriesComponent/NewDataAnnouncer.js", [b["Core/Globals.js"], b["Core/Utilities.js"], b["Accessibility/Utils/Announcer.js"], b["Accessibility/Utils/ChartUtilities.js"], b["Accessibility/Utils/EventProvider.js"], b["Accessibility/Components/SeriesComponent/SeriesDescriber.js"]], function(b, r, n, q, m, w) {
    function v(a) {
    ...
    class d {
      ...
      onSeriesAdded(a) {
        this.chart.options.accessibility.announceNewData.enabled && (this.dirty.hasDirty = !0, this.dirty.allSeries[a.name + a.index] =
          a, this.dirty.newSeries = g(this.dirty.newSeries) ? void 0 : a)
      }
      announceDirtyData() {
        const a = this;
      ...
      buildAnnouncementMessage(d, f, g) {
        ...
        if (l.announcementFormatter && (d = l.announcementFormatter(d, f, g), !1 !== d)) return d.length ? d : null;
        d = b.charts && 1 < b.charts.length ? "Multiple" : "Single";
        d = f ? "newSeriesAnnounce" + d : g ? "newPointAnnounce" + d : "newDataAnnounce";
        l = h(e);
      ...
      function b(a) {
        ...
        c && c.chart === b && b.options.accessibility.announceNewData.enabled &&
      ...
      a.compose = function(d) {
        r.pushUnique(a.composedMembers, d) && (l(d, "addPoint", b), l(d, "updatedData", c))
      }
    })(d || (d = {}));
    return d
  });
  x(b, "Accessibility/ProxyElement.js", [b["Core/Globals.js"], b["Core/Utilities.js"], b["Accessibility/Utils/EventProvider.js"],
    b["Accessibility/Utils/ChartUtilities.js"], b["Accessibility/Utils/HTMLUtilities.js"]
  ], function(b, r, n, q, m) {
    const {
      doc: w
    } = b, {
      ...
      fireEventOnWrappedOrUnwrappedElement: g
    } = q, {
      cloneMouseEvent: h,
      cloneTouchEvent: a,
      getFakeMouseEvent: c,
    ...
    class e {
      constructor(a, b, c, d) {
        ...
        f ?
          (c && !a.styledMode && (f.style.listStyle = "none"), f.appendChild(e), this.element = f) : this.element = e;
      ...
      updateTarget(a, b) {
        ...
        v(this.buttonElement, l({
          "aria-label": this.getTargetAttr(a.click, "aria-label")
        }, c));
        this.eventProvider.removeAddedEvents();
        this.addProxyEventsToButton(this.buttonElement,
          a.click);
  ...
  x(b, "Accessibility/ProxyProvider.js", [b["Core/Globals.js"], b["Core/Utilities.js"], b["Accessibility/Utils/ChartUtilities.js"], b["Accessibility/Utils/DOMElementProvider.js"], b["Accessibility/Utils/HTMLUtilities.js"], b["Accessibility/ProxyElement.js"]], function(b, r, n, q, m, w) {
    const {
      doc: v
    } = b, {
      attr: y,
    ...
    class c {
      ...
      updateGroupProxyElementPositions(a) {
        (a =
          this.groups[a]) && a.proxyElements.forEach(a => a.refreshPosition())
      }
      destroy() {
        this.domElementProvider.destroyCreatedElements()
      }
  ...
  x(b, "Stock/RangeSelector/RangeSelectorComposition.js", [b["Core/Defaults.js"], b["Stock/RangeSelector/RangeSelectorDefaults.js"], b["Core/Utilities.js"]], function(b, r, n) {
    function q() {
      const a = this.range,
        b = a.type,
        c = this.max,
      ...
      let f, h;
      A(a) ? (f = c - a, h = a) : a && (f = c + e(c, -(a.count || 1)), this.chart && (this.chart.fixedRange = c -
        f));
      const g = H(this.dataMin, Number.MIN_VALUE);
      A(f) || (f = g);
      f <= g && (f = g, "undefined" === typeof h && (h = e(f, a.count)), this.newMax = Math.min(f + h, H(this.dataMax, Number.MAX_VALUE)));
    ...
    function w() {
      ...
      b && (A(b.deferredYTDClick) && (b.clickButton(b.deferredYTDClick), delete b.deferredYTDClick), a.forEach(a => {
        a.updateNames();
        a.setScale()
    ...
    function v(a) {
      ...
      const f = a.rangeSelector,
        h = () => {
          f && (b = a.xAxis[0].getExtremes(), c = a.legend, e = f && f.options.verticalAlign, A(b.min) && f.render(b.min, b.max), c.display && "top" === e && e === c.options.verticalAlign && (p = x(a.spacingBox), p.y = "vertical" === c.options.layout ? a.plotTop : p.y + f.getHeight(), c.group.placed = !1,
            c.align(p)))
        };
      f && (B(D, b => b[0] === a) || D.push([a, [d(a.xAxis[0], "afterSetExtremes", function(a) {
    ...
    function h(a) {
      ...
      b && b.enabled && !e(d) && this.options.rangeSelector && (this.options.rangeSelector.enabled = !0, this.rangeSelector = d = new z(this));
      this.extraTopMargin = this.extraBottomMargin = !1;
      d && (v(this), b = b && b.verticalAlign || d.options && d.options.verticalAlign, d.options.floating || ("bottom" === b ? this.extraBottomMargin = !0 : "middle" !==
        b && (this.extraTopMargin = !0)), this.extraBottomMargin !== a || this.extraTopMargin !== c) && (this.isDirtyBox = !0)
    }
    const {
      defaultOptions: a,
      setOptions: c
    ...
    return {
      compose: function(b, k, e) {
        ...
        n.pushUnique(F, k) && (d(k, "afterGetContainer", m), d(k, "beforeRender", w), d(k, "destroy", y), d(k, "getMargins", l), d(k, "render", g), d(k, "update", h), k.prototype.callbacks.push(v));
        n.pushUnique(F, c) && (f(a, {
          rangeSelector: r.rangeSelector
        }), f(a.lang, r.lang))
      }
    }
  });
  x(b, "Stock/RangeSelector/RangeSelector.js", [b["Core/Axis/Axis.js"], b["Core/Defaults.js"], b["Core/Globals.js"], b["Stock/RangeSelector/RangeSelectorComposition.js"], b["Core/Renderer/SVG/SVGElement.js"], b["Core/Utilities.js"]], function(b, r, n, q, m, w) {
    function v(a) {
      if (-1 !== a.indexOf("%L")) return "text";
      const b = "aAdewbBmoyY".split("").some(b => -1 !== a.indexOf("%" + b)),
        c = "HkIlMS".split("").some(b => -1 !== a.indexOf("%" + b));
      return b && c ? "datetime-local" : b ? "date" :
        c ? "time" : "text"
    }
    const {
      defaultOptions: y
    ...
    class u {
      ...
      clickButton(c, d) {
        const k = this.chart,
          ...
          t = k.xAxis[0];
        var h = k.scroller &&
          k.scroller.getUnionExtremes() || t || {},
          g = e.type;
        const u = e.dataGrouping;
        let m = h.dataMin,
          I = h.dataMax,
          n, C = t && Math.round(Math.min(t.max, D(I, t.max))),
          q;
        h = e._range;
        let r, w, v, y = !0;
        if (null !== m && null !== I) {
          k.fixedRange = h;
          this.setSelected(c);
          u && (this.forcedDataGrouping = !0, b.prototype.setDataGrouping.call(t || {
            chart: this.chart
          }, u, !1), this.frozenStates = e.preserveDataGrouping);
          if ("month" === g || "year" === g) t ? (g = {
            range: e,
            max: C,
            chart: k,
            dataMin: m,
            dataMax: I
          }, n = t.minFromRange.call(g), B(g.newMax) && (C = g.newMax), y = !1) : h = e;
          else if (h) n =
            Math.max(C - h, m), C = Math.min(n + h, I), y = !1;
          else if ("ytd" === g)
            if (t) {
              if ("undefined" === typeof I || "undefined" === typeof m) m = Number.MAX_VALUE, I = Number.MIN_VALUE, k.series.forEach(a => {
                if (a = a.xData) m = Math.min(a[0], m), I = Math.max(a[a.length - 1], I)
              }), d = !1;
          ...
          else "all" === g && t && (k.navigator && k.navigator.baseSeries[0] && (k.navigator.baseSeries[0].xAxis.options.range = void 0), n = m, C = I);
          y && e._offsetMin && a(n) && (n += e._offsetMin);
          e._offsetMax &&
            a(C) && (C += e._offsetMax);
          this.dropdown && (this.dropdown.selectedIndex = c + 1);
          t ? t.setExtremes(n, C, D(d, !0), void 0, {
            trigger: "rangeSelectorButton",
            rangeSelectorButton: e
          }) : (q = z(k.options.xAxis)[0], v = q.range, q.range = h, w = q.min, q.min = r, l(k, "load", function() {
            q.range = v;
            q.min = w
          }));
      ...
      init(a) {
        ...
        this.eventsToUnbind.push(l(a, "load", function() {
          a.xAxis && a.xAxis[0] && l(a.xAxis[0], "setExtremes", function(c) {
      ...
      updateButtonStates() {
        ...
        a.buttonOptions.forEach((b, k) => {
          ...
          ("month" === t || "year" === t) && e + 36E5 >= 864E5 * {
            ...
            month: 31,
            year: 366
          } [t] * h + G ? p = !0 : "ytd" === t ? (p = m - u + G === e, I = !J) : "all" === t && (p = d.max - d.min >= l - g, r = !J && q && p);
          t = !z && (M || N || r || f);
          h = J && p || p && !q && !I || J && a.frozenStates;
          t ? b = 3 : h && (q = !0, b = 2);
          E.state !== b && (E.setState(b), c && (c.options[k + 1].disabled = t, 2 === b && (c.selectedIndex = k + 1)), 0 === b && C === k && a.setSelected())
        })
      }
      ...
      setInputValue(b, c) {
        ...
        if (e) {
          ...
          e.value = k.dateFormat(this.inputTypeFormats[e.type] || d.inputEditDateFormat, f);
          b && b.attr({
            text: k.dateFormat(d.inputDateFormat, f)
          })
        }
      }
      setInputExtremes(a, b, c) {
        if (a = "min" === a ? this.minInput : this.maxInput) {
          const d = this.inputTypeFormats[a.type],
            k = this.chart.time;
          d &&
            (b = k.dateFormat(d, b), a.min !== b && (a.min = b), c = k.dateFormat(d, c), a.max !== c && (a.max = c))
        }
      }
      showInput(a) {
        ...
        if ((a = "min" === a ? this.minInput : this.maxInput) && b && this.inputGroup) {
          ...
          c && e ? h(a, {
            ...
            left: Math.min(Math.round(b.x + d - (a.offsetWidth - b.width) /
              2), this.chart.chartWidth - a.offsetWidth) + "px",
      ...
      defaultInputDateParser(a, b, c) {
        ...
        if (b) d += "Z";
          ...
          var k;
          if (k = n.isSafari) k = d, k = !(6 < k.length && (k.lastIndexOf("-") === k.length - 6 || k.lastIndexOf("+") === k.length - 6));
          k && (k = (new Date(d)).getTimezoneOffset() / 60, d += 0 >= k ? `+${H(-k)}:00` :
            `-${H(k)}:00`)
        }
        d = Date.parse(d);
        B(d) || (a = a.split("-"), d = Date.UTC(F(a[0]), F(a[1]) - 1, F(a[2])));
      ...
      drawInput(a) {
        function b() {
          ...
          h !== Number(C.getAttribute("data-hc-time-previous")) && B(h) && (C.setAttribute("data-hc-time-previous", h), z && b && B(p) ? h > Number(b.getAttribute("data-hc-time")) ? h = void 0 : h < p && (h = p) : d && B(e) &&
            (h < Number(d.getAttribute("data-hc-time")) ? h = void 0 : h > e && (h = e)), "undefined" !== typeof h && k.setExtremes(z ? h : k.min, z ? k.max : h, void 0, void 0, {
        ...
        const {
          ...
          div: d,
          inputGroup: k
        } = this, f = this, l = c.renderer.style || {};
        var u = c.renderer;
        const m = c.options.rangeSelector,
          z = "min" === a;
        var q = y.lang[z ? "rangeSelectorFrom" : "rangeSelectorTo"] || "";
        q = u.label(q, 0).addClass("highcharts-range-label").attr({
          padding: q ? 2 : 0,
          height: q ? m.inputBoxHeight : 0
        }).add(k);
        u = u.label("", 0).addClass("highcharts-range-input").attr({
          padding: 2,
        ...
        c.styledMode || (q.css(A(l, m.labelStyle)), u.css(A({
          color: "#333333"
        }, l, m.inputStyle)), h(C, e({
          position: "absolute",
          border: 0,
        ...
        if (!1 !== h.enabled) {
          this.rendered ||
            (this.group = e.g("range-selector-group").attr({
              zIndex: 7
            }).add(), this.div = g("div", void 0, {
              position: "relative",
              height: 0,
              zIndex: t
            }), this.buttonOptions.length && this.renderButtons(), k.parentNode && k.parentNode.insertBefore(this.div, k), f && (this.inputGroup = e.g("input-group").add(this.group), e = this.drawInput("min"), this.minDateBox = e.dateBox, this.minLabel = e.label, this.minInput = e.input, e = this.drawInput("max"), this.maxDateBox = e.dateBox, this.maxLabel = e.label, this.maxInput = e.input));
          if (f && (this.setInputValue("min",
              b), this.setInputValue("max", c), b = d.scroller && d.scroller.getUnionExtremes() || d.xAxis[0] || {}, a(b.dataMin) && a(b.dataMax) && (d = d.xAxis[0].minRange || 0, this.setInputExtremes("min", b.dataMin, Math.min(b.dataMax, this.getInputValue("max")) - d), this.setInputExtremes("max", Math.max(b.dataMin, this.getInputValue("min")) + d, b.dataMax)), this.inputGroup)) {
            let a = 0;
      ...
      renderButtons() {
        const {
          ...
          chart: b,
          options: c
        } = this, d = y.lang, e = b.renderer, h = A(c.buttonTheme), u = h && h.states, m = h.width || 28;
        delete h.width;
        delete h.states;
        this.buttonGroup = e.g("range-selector-buttons").add(this.group);
        const z = this.dropdown = g("select", void 0, {
          position: "absolute",
          width: "1px",
          height: "1px",
          padding: 0,
        ...
        this.chart.styledMode || (this.zoomText.css(c.labelStyle), h["stroke-width"] = D(h["stroke-width"], 0));
        g("option", {
        ...
        this.buttonOptions.forEach((b, c) => {
          ...
          a[c] = e.button(b.text, 0, 0, a => {
            ...
            this.isActive = !0
          }, h, u && u.hover, u && u.select, u && u.disabled).attr({
            "text-align": "center",
            width: m
          }).add(this.buttonGroup);
      ...
      alignElements() {
        ...
        var g = c.options;
        const l = g.exporting && !1 !== g.exporting.enabled && g.navigation && g.navigation.buttonOptions,
          {
            buttonPosition: u,
            inputPosition: m,
            verticalAlign: z
          } = f;
        g = (a, b) => l && this.titleCollision(c) && "top" === z && "right" === b.align && b.y - a.getBBox().height - 12 < (l.y || 0) + (l.height || 0) + c.spacing[0] ? -40 : 0;
        var q = c.plotLeft;
        if (d && u && m) {
          ...
          r = 0;
          e && (r = g(e, m), "left" === m.align ? n = q : "right" === m.align && (n = -Math.max(c.axisOffset[1], -r)), e.align({
            y: m.y,
          ...
          n = 0;
          "bottom" === z && (n = (n = c.legend && c.legend.options) && "bottom" === n.verticalAlign && n.enabled && !n.floating ? c.legend.legendHeight + D(n.margin, 10) : 0, q = q + n - 20, n = g - q - (f.floating ?
            0 : f.y) - (c.titleOffset ? c.titleOffset[2] : 0) - 10);
          if ("top" === z) f.floating && (n = 0), c.titleOffset && c.titleOffset[0] && (n = c.titleOffset[0]), n += c.margin[0] - c.spacing[0] || 0;
          else if ("middle" === z)
            if (m.y === u.y) n = g;
            else if (m.y || u.y) n = 0 > m.y || 0 > u.y ? n - Math.min(m.y, u.y) : g - q;
          ...
          f.inputEnabled && k && p && (k.style.marginTop = d.translateY + "px", p.style.marginTop = d.translateY + "px");
      ...
      alignButtonGroup(a, b) {
        const {
          ...
          buttonPosition: f
        } = d, k = c.plotLeft - c.spacing[3];
        let h = f.x - c.spacing[3];
        "right" === f.align ? h += a - k : "center" === f.align && (h -= k / 2);
        e && e.align({
          y: f.y,
      ...
      positionButtons() {
        const {
          ...
          options: c,
          zoomText: d
        } = this, e = b.hasLoaded ? "animate" : "attr", {
          buttonPosition: f
        } = c, h = b.plotLeft;
        let g = h;
        ...
        for (let b = 0, d = this.buttonOptions.length; b <
          d; ++b)
          if ("hidden" !== a[b].visibility) a[b][e]({
            x: g
          }), g += a[b].width + c.buttonSpacing;
          else a[b][e]({
            x: h
          })
      }
      handleCollision(a) {
        ...
        d && c ? k.align === e.align || g(this.initialButtonGroupWidth + 20) ? "responsive" === f ? (this.collapseButtons(a), g(h()) && l()) : l() : "responsive" === f && this.expandButtons() : c && "responsive" === f && (this.initialButtonGroupWidth > b.plotWidth ? this.collapseButtons(a) : this.expandButtons())
      }
      collapseButtons(a) {
        const {
          buttons: b,
          ...
          options: f,
          zoomText: k
        } = this, h = d.userOptions.rangeSelector && d.userOptions.rangeSelector.buttonTheme || {}, g = a => ({
          text: a ? `${a} \u25be` : "\u25be",
          width: "auto",
        ...
        l || (e && (e.selectedIndex = 0), b[0].show(), b[0].attr(g(this.zoomText && this.zoomText.textStr)));
        const {
          align: u
        } =
        f.buttonPosition;
        this.positionButtons();
        "right" !== u && "center" !== u || this.alignButtonGroup(a, b[this.currentButtonIndex()].getBBox().width);
        this.showDropdown()
      }
      expandButtons() {
        const {
      ...
      showDropdown() {
        ...
        if (a && d) {
          const {
            translateX: e,
            translateY: f
          } = a, k = b[this.currentButtonIndex()].getBBox();
          h(d, {
  ...
  x(b, "Accessibility/Components/RangeSelectorComponent.js", [b["Stock/RangeSelector/RangeSelector.js"], b["Accessibility/AccessibilityComponent.js"], b["Accessibility/Utils/ChartUtilities.js"], b["Accessibility/Utils/Announcer.js"], b["Accessibility/KeyboardNavigationHandler.js"], b["Core/Utilities.js"]], function(b, r, n, q, m, w) {
    const {
      unhideChartElementFromAT: v,
      getAxisRangeDescription: y
    } =
    n, {
      addEvent: l,
      attr: g
    ...
    class h extends r {
      ...
      onChartUpdate() {
        const a = this.chart,
          b = this,
          d = a.rangeSelector;
        d && (this.updateSelectorVisibility(), this.setDropdownAttrs(), d.buttons && d.buttons.length && d.buttons.forEach(a => {
          b.setRangeButtonAttrs(a)
        }), d.maxInput && d.minInput && ["minInput", "maxInput"].forEach(function(c, f) {
          if (c = d[c]) v(a, c), b.setRangeInputAttrs(c, "accessibility.rangeSelector." + (f ? "max" : "min") +
            "InputLabel")
        }))
      }
      ...
      onButtonNavKbdArrowKey(a, b) {
        ...
        return f.highlightRangeSelectorButton(f.highlightedRangeSelectorItemIx + b) ? c.success : h ? (a.init(b), c.success) : c[0 < b ? "next" : "prev"]
      }
      ...
      initDropdownNav() {
        const a = this.chart,
          ...
          d = b &&
          b.dropdown;
        b && d && (a.setFocusToElement(b.buttonGroup, d), this.removeDropdownKeydownHandler && this.removeDropdownKeydownHandler(), this.removeDropdownKeydownHandler = l(d, "keydown", b => {
          const c = a.accessibility;
          (b.which || b.keyCode) === this.keyCodes.tab && (b.preventDefault(), b.stopPropagation(), c && (c.keyboardNavigation.tabindexContainer.focus(), c.keyboardNavigation.move(b.shiftKey ? -1 : 1)))
        }))
      }
      ...
      function c(a) {
        ...
        return b[a] ? (this.setFocusToElement(b[a].box, b[a].element), a !==
          d && (this.oldRangeSelectorItemState = b[a].state, b[a].setState(1)), !0) : !1
      }
  ...
  x(b, "Accessibility/Components/SeriesComponent/ForcedMarkers.js", [b["Core/Utilities.js"]], function(b) {
    ...
    (function(m) {
      ...
      function g() {
        ...
        if (b) {
          if (a.marker &&
            !1 === a.marker.enabled && (this.a11yMarkersForced = !0, q(this.options)), this._hasPointMarkers && this.points && this.points.length)
            for (a = this.points.length; a--;) {
              b = this.points[a];
              const c = b.options;
              var d = b.hasForcedA11yMarker;
              delete b.hasForcedA11yMarker;
              c.marker && (d = d && 0 === v(c), c.marker.enabled && !d ? (n(!0, c.marker, {
                states: {
                  normal: {
                    opacity: v(c) || 1
                  }
                }
              }), b.hasForcedA11yMarker = !1) : !1 === c.marker.enabled && (q(c), b.hasForcedA11yMarker = !0))
            }
      ...
      m.compose = function(a) {
        b.pushUnique(h, a) && (r(a, "afterSetOptions", l), r(a, "render", g), r(a, "afterRender", y))
      }
    })(q || (q = {}));
    return q
  });
  x(b, "Accessibility/Components/SeriesComponent/SeriesKeyboardNavigation.js", [b["Core/Series/Point.js"], b["Core/Series/Series.js"], b["Core/Series/SeriesRegistry.js"], b["Core/Globals.js"], b["Core/Utilities.js"],
    b["Accessibility/KeyboardNavigationHandler.js"], b["Accessibility/Utils/EventProvider.js"], b["Accessibility/Utils/ChartUtilities.js"]
    ...
    function g(a) {
      ...
      return d && !1 === d.enabled || !1 === c.enabled || !1 === a.options.enableMouseTracking || !a.visible ||
    ...
    function h(a) {
      ...
      return a.isNull && b.keyboardNavigation.seriesNavigation.skipNullPoints || !1 === a.visible || !1 === a.isInside || c || g(a.series)
    }
    ...
    class F {
      ...
      getKeyboardNavigationHandler() {
        ...
        return new w(f, {
          keyCodeMap: [
            [h ? [e.up, e.down] : [e.left, e.right], function(a) {
              return b.onKbdSideways(this, a)
            }],
            [h ? [e.left, e.right] : [e.up, e.down], function(a) {
              return b.onKbdVertical(this,
                a)
            }],
            [
              [e.enter, e.space],
              function(a, b) {
                if (a = f.highlightedPoint) b.point = a, A(a.series, "click", b), a.firePointEvent("click");
                return this.response.success
              }
            ],
            [
      ...
      onKbdVertical(a, b) {
        ...
        if (d.mode && "serialize" === d.mode) return this.attemptHighlightAdjacentPoint(a,
          b);
      ...
      attemptHighlightAdjacentPoint(a,
        b) {
        const e = this.chart,
      ...
      function b(a) {
        ...
        return h(d) ? (b = d.series, g(b) ? this.highlightedPoint = a ? b.points[b.points.length - 1] : b.points[0] : this.highlightedPoint = d, this.highlightAdjacentPoint(a)) : d.highlight()
      }
        ...
        this.series.forEach(e => {
          g(e) || e.points.forEach(f => {
            if (v(f.plotY) && v(f.plotX) && f !== b) {
              ...
              !(0 >= g && a || 0 <= g && !a || 5 > k || h(f)) && k < c && (c = k, d = f)
            }
          })
        });
      ...
      function d(a) {
        ...
        if (!this.highlightedPoint) return c =
          a ? this.series && this.series[0] : c, (d = a ? c && c.points && c.points[0] : d) ? d.highlight() : !1;
        c = this.series[b.series.index + (a ? -1 : 1)];
        if (!c) return !1;
        d = f(b, c, 4);
        if (!d) return !1;
        if (g(c)) return d.highlight(), a = this.highlightAdjacentSeries(a), a ? a : (b.highlight(), !1);
        d.highlight();
      ...
      function f(a, b, c, d) {
        let e = Infinity;
        let f, h = b.points.length;
        const g = a => !(v(a.plotX) && v(a.plotY));
        if (!g(a)) {
          for (; h--;) {
            var k = b.points[h];
            g(k) || (k = (a.plotX - k.plotX) * (a.plotX - k.plotX) * (c || 1) + (a.plotY - k.plotY) *
              (a.plotY - k.plotY) * (d || 1), k < e && (e = k, f = h))
          }
      ...
      a.compose = function(a, f, h) {
        ...
        m.pushUnique(r, h) && (f = h.prototype, f.keyboardMoveVertical = !0, ["column", "gantt", "pie"].forEach(a => {
      ...
      class l extends b {
        ...
        onChartRender() {
          this.chart.series.forEach(function(b) {
            !1 !== (b.options.accessibility && b.options.accessibility.enabled) && b.visible ? y(b) : v(b)
          })
        }
        getKeyboardNavigation() {
  ...
  x(b, "Accessibility/Components/ZoomComponent.js", [b["Accessibility/AccessibilityComponent.js"],
    b["Accessibility/Utils/ChartUtilities.js"], b["Accessibility/Utils/HTMLUtilities.js"], b["Accessibility/KeyboardNavigationHandler.js"], b["Core/Utilities.js"]
  ], function(b, r, n, q, m) {
    const {
      unhideChartElementFromAT: v
    } = r, {
    ...
    class g extends b {
      ...
      updateProxyOverlays() {
        ...
        b.resetZoomButton && this.createZoomProxyButton(b.resetZoomButton, "resetZoomProxyButton",
      ...
      onMapKbdArrow(b, a) {
        ...
        a = (f ? c.plotHeight : c.plotWidth) / 10 * (a === d.left ||
          a === d.up ? 1 : -1);
        d = 10 * Math.random();
        c = {
      ...
      onMapKbdTab(b, a) {
        ...
        if (d) return c.mapView && c.mapView.zoomBy(),
          b[a ? "prev" : "next"];
      ...
      getKeyboardNavigation() {
        return [this.simpleButtonNavigation("resetZoomButton",
  ...
  x(b, "Accessibility/HighContrastMode.js", [b["Core/Globals.js"]], function(b) {
    ...
    return {
      isHighContrastModeActive: function() {
        ...
        if (q.matchMedia && b) return q.matchMedia("(-ms-high-contrast: active)").matches;
        ...
        return q.matchMedia && q.matchMedia("(forced-colors: active)").matches
      },
  ...
  x(b, "Accessibility/Options/DeprecatedOptions.js", [b["Core/Utilities.js"]], function(b) {
    ...
    function m(b) {
      b.axes.forEach(function(g) {
        (g = g.options) && g.description && (g.accessibility = g.accessibility || {}, g.accessibility.description = g.description, x(32, !1, b, {
    ...
    function v(b) {
      ...
      b.series.forEach(function(h) {
        Object.keys(g).forEach(function(a) {
          let c = h.options[a];
          "accessibility.pointDescriptionFormatter" === a && (c = h.options.accessibility &&
            h.options.accessibility.pointDescriptionFormatter);
          "undefined" !== typeof c && (r(h.options, g[a], "skipKeyboardNavigation" === a ? !c : c), x(32, !1, b, {
            [`series.${a}`]: "series." + g[a].join(".")
          }))
        })
      })
    }
    ...
    return function(b) {
      ...
      n(b, ["accessibility", "keyboardNavigation"], ["accessibility", "keyboardNavigation", "seriesNavigation"], {
  ...
  x(b, "Accessibility/Accessibility.js", [b["Core/Defaults.js"], b["Core/Globals.js"], b["Core/Utilities.js"], b["Accessibility/Utils/HTMLUtilities.js"], b["Accessibility/A11yI18n.js"], b["Accessibility/Components/ContainerComponent.js"],
    ...
    b["Accessibility/HighContrastTheme.js"], b["Accessibility/Options/A11yDefaults.js"], b["Accessibility/Options/LangDefaults.js"], b["Accessibility/Options/DeprecatedOptions.js"]
    ...
    class E {
      ...
      init(a) {
        this.chart = a;
        v.addEventListener ? (D(a), this.proxyProvider =
          new c(this.chart), this.initComponents(), this.keyboardNavigation = new l(a, this.components)) : (this.zombie = !0, this.components = {}, a.renderTo.setAttribute("aria-hidden", !0))
      }
      initComponents() {
        const a = this.chart,
          b = this.proxyProvider,
      ...
      update() {
        ...
        !b.highContrastModeActive && B.isHighContrastModeActive() && B.setHighContrastTheme(b);
        k(b, "afterA11yUpdate", {
          accessibility: this
        })
      }
      ...
      function k(a) {
        if (a =
          a.options.accessibility) a.customComponents && (this.options.accessibility.customComponents = a.customComponents, delete a.customComponents), t(!0, this.options.accessibility, a), this.accessibility && this.accessibility.destroy && (this.accessibility.destroy(), delete this.accessibility);
        this.a11yDirty = !0
      }
      ...
      function p() {
        ...
        c && c.enabled ? a && !a.zombie ? a.update() : (this.accessibility = a = new b(this), !a.zombie) && a.update() : a ? (a.destroy && a.destroy(), delete this.accessibility) :
      ...
      b.compose = function(b, t, v, u, w, y) {
        ...
        x.compose(b, w);
        y && d.compose(b, y);
        n.pushUnique(r, b) && (b.prototype.updateA11yEnabled = p, z(b, "destroy", c), z(b, "render", f), z(b, "update", k), ["addSeries", "init"].forEach(a => {
          z(b, a, function() {
            this.a11yDirty = !0
          })
        }), ["afterApplyDrilldown",
        ...
        n.pushUnique(r, u) && ["update", "updatedData", "remove"].forEach(a => {
          z(u, a, function() {
  ...
  x(b, "masters/modules/accessibility.src.js", [b["Core/Globals.js"], b["Accessibility/Accessibility.js"], b["Accessibility/AccessibilityComponent.js"], b["Accessibility/Utils/ChartUtilities.js"],
    b["Accessibility/Utils/HTMLUtilities.js"], b["Accessibility/KeyboardNavigationHandler.js"], b["Accessibility/Components/SeriesComponent/SeriesDescriber.js"]
