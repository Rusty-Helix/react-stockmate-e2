...
$jscomp.polyfillIsolated = function(a, c, b, d) {
  ...
  null != c && (a ? $jscomp.defineProperty($jscomp.polyfills, h, {
    ...
    writable: !0,
    value: c
  }) : c !== b && ($jscomp.propertyToPolyfillSymbol[h] = $jscomp.IS_SYMBOL_NATIVE ? $jscomp.global.Symbol(h) : $jscomp.POLYFILL_PREFIX + h, h = $jscomp.propertyToPolyfillSymbol[h],
...
(function(a) {
  "object" === typeof module && module.exports ? (a["default"] = a, module.exports = a) : "function" === typeof define && define.amd ? define("highcharts/modules/data", ["highcharts"], function(c) {
    a(c);
    a.Highcharts = c;
    return a
  ...
  function c(a, c, h, q) {
    a.hasOwnProperty(c) || (a[c] = q.apply(null, h), "function" === typeof CustomEvent && window.dispatchEvent(new CustomEvent("HighchartsModuleLoaded", {
      detail: {
        path: c,
        module: a[c]
      }
      ...
      const {
        ...
        ajax: function(a) {
          ...
          b.onreadystatechange = function() {
            ...
            if (4 === b.readyState) {
              if (200 === b.status) {
                if ("blob" !== a.responseType && (c = b.responseText, "json" === a.dataType)) try {
                  c = JSON.parse(c)
                } catch (B) {
  ...
  c(a, "Extensions/Data.js", [a["Core/Chart/Chart.js"], a["Core/Defaults.js"], a["Core/Globals.js"], a["Core/HttpUtilities.js"], a["Core/Series/Point.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]], function(a, c, h, q, v, E, A) {
    ...
    class D {
      ...
      static rowsToColumns(f) {
        ...
        if (f)
          for (g = [], k = f.length, a = 0; a < k; a++)
            for (e = f[a].length, n = 0; n < e; n++) g[n] || (g[n] = []), g[n][a] = f[a][n];
        return g
      }
      constructor(a, l = {}, k) {
      ...
      init(a, l, k) {
        ...
        this.firstRowAsNames = G(a.firstRowAsNames,
          this.firstRowAsNames, !0);
      ...
      getColumnDistribution() {
        ...
        l.forEach(f => {
          ...
          for (p = 0; p < k; p++) l.hasReader(r[p]) ||
            l.addColumnReader(void 0, r[p]);
          c.push(l);
          z++
        });
      ...
      parseCSV(a) {
        function f(a, f, e, l) {
          ...
          function b() {
            z > w || w > p ? (++w, u = "") : (!isNaN(parseFloat(u)) && isFinite(u) ? (u = parseFloat(u), c("number")) : isNaN(Date.parse(u)) ? c("string") : (u = u.replace(/\//g, "-"), c("date")), g.length < t + 1 && g.push([]), e || (g[t][f] = u), u = "", ++t, ++w)
          }
          let n = 0,
            m = "",
            d = "",
        ...
        function k(a) {
          ...
          a.some(function(a, e) {
            ...
            for (let n = 0; n < a.length; n++) {
              ...
              else "undefined" !== typeof m[e] ? (b = b.trim(), isNaN(Date.parse(b)) ? !isNaN(b) && isFinite(b) || m[e]++ : m[e]++, b = "") : b += e;
              "," === e && l++;
              "." === e && f++
            }
          });
          k = m[";"] > m[","] ? ";" : ",";
          c.decimalPoint || (c.decimalPoint = f > l ? "." : ",", e.decimalRegex =
            new RegExp("^(-?[0-9]+)" + c.decimalPoint + "([0-9]+)$"));
          return k
        }
        ...
        function b(a, f) {
          ...
          for (; n < f; n++)
            if ("undefined" !== typeof a[n] && a[n] && a[n].length)
              for (b = a[n].trim().replace(/\//g, " ").replace(/\-/g, " ").replace(/\./g, " ").split(" "), g = ["", "", ""], d = 0; d < b.length; d++) d < g.length && (b[d] = parseInt(b[d], 10), b[d] && (k[d] = !k[d] || k[d] < b[d] ? b[d] : k[d], "undefined" !== typeof l[d] ? l[d] !== b[d] && (l[d] = !1) : l[d] = b[d], 31 < b[d] ? g[d] = 100 > b[d] ? "YY" : "YYYY" : 12 < b[d] &&
                31 >= b[d] ? (g[d] = "dd", m = !0) : g[d].length || (g[d] = "mm")));
          if (m) {
            for (d = 0; d < l.length; d++) !1 !== l[d] ? 12 < k[d] && "YY" !== g[d] && "YYYY" !== g[d] && (g[d] = "YY") : 12 < k[d] && "mm" === g[d] && (g[d] = "dd");
            3 === g.length && "dd" === g[1] && "dd" === g[2] && (g[2] = "YY");
            a = g.join("/");
            return (c.dateFormats || e.dateFormats)[a] ? a : (N("deduceDateFailed"), "YYYY/mm/dd")
          }
          return "YYYY/mm/dd"
        }
        const e = this,
        ...
        if (d) {
          ...
          c.columnTypes && 0 !== c.columnTypes.length || !r.length || !r[0].length || "date" !== r[0][1] || c.dateFormat ||
            (c.dateFormat = b(g[0]));
          this.dataFound()
        }
        return g
      ...
      parseTable() {
        ...
        a.table && (a = a.table, "string" === typeof a && (a = L.getElementById(a)), [].forEach.call(a.getElementsByTagName("tr"), (a, f) => {
          f >= k && f <= c && [].forEach.call(a.children, (a, c) => {
            const b = l[c - e];
            let d = 1;
            if (("TD" === a.tagName || "TH" === a.tagName) && c >= e && c <= g)
              for (l[c - e] || (l[c - e] = []), l[c - e][f - k] = a.innerHTML; f - k >= d && void 0 ===
                b[f - k - d];) b[f - k - d] = null, d++
          })
        }), this.dataFound());
        return l
      }
      fetchLiveData() {
        function a(f) {
          function b(b, g, n) {
            ...
            if (!b || !/^(http|\/|\.\/|\.\.\/)/.test(b)) return b && c.error && c.error("Invalid URL"), !1;
      ...
      parseGoogleSpreadsheet() {
        function a(f) {
          const e = ["https://sheets.googleapis.com/v4/spreadsheets", d, "values", h(), "?alt=json&majorDimension=COLUMNS&valueRenderOption=UNFORMATTED_VALUE&dateTimeRenderOption=FORMATTED_STRING&key=" +
            b.googleAPIKey
          ].join("/");
          H({
            url: e,
        ...
        const c = this,
          ...
          h = () => {
            ...
            let f = "ABCDEFGHIJKLMNOPQRSTUVWXYZ".charAt(G(b.endColumn,
              -1)) || "ZZ";
            C(b.endRow) && (f += b.endRow + 1);
            return `${a}:${f}`
          };
        d && (delete b.googleSpreadsheetKey, a(function(a) {
          a = a.values;
          if (!a || 0 === a.length) return !1;
          const f = a.reduce((a, f) => Math.max(a, f.length), 0);
          a.forEach(a => {
            for (let b = 0; b < f; b++) "undefined" === typeof a[b] && (a[b] = null)
          });
          e && e.series ? e.update({
            data: {
              columns: a
          ...
          if (e)(b = this.dateFormats[e]) || (b = this.dateFormats["YYYY/mm/dd"]), (d = a.match(b.regex)) && (c = b.parser(d));
            ...
            for (f in this.dateFormats)
              if (b = this.dateFormats[f], d = a.match(b.regex)) {
                ...
                c = b.parser(d);
                break
              } d || (a.match(/:.+(GMT|UTC|[Z+-])/) && (a = a.replace(/\s*(?:GMT|UTC)?([+-])(\d\d)(\d\d)$/, "$1$2:$3").replace(/(?:\s+|GMT|UTC)([+-])/, "$1").replace(/(\d)\s*(?:GMT|UTC|Z)$/, "$1+00:00")), d = Date.parse(a), "object" === typeof d && null !== d && d.getTime ? c = d.getTime() - 6E4 * d.getTimezoneOffset() : J(d) && (c = d - 6E4 * (new Date(d)).getTimezoneOffset()))
        }
        return c
      }
      getData() {
        ...
        if (b.complete || b.afterComplete) {
          ...
          h = []; {
            ...
            for (q = 0; q < p.length; q += 1)
              for (b = p[q].getReferencedColumnIndexes(), g = 0; g < b.length; g += 1) e[b[g]] = !1;
          ...
          0 < c.length && 0 < c[0].readers.length && (p = a[c[0].readers[0].columnIndex], "undefined" !== typeof p && (p.isDatetime ? d = "datetime" : p.isNumeric || (d = "category")));
          if ("category" === d)
            for (e = 0; e < c.length; e++)
              for (p = c[e], r = 0; r < p.readers.length; r++) "x" ===
                p.readers[r].configName && (p.readers[r].configName = "name");
          for (e = 0; e < c.length; e++) {
            p = c[e];
            r = [];
      ...
      update(a, b) {
        ...
        a && (a.afterComplete = function(a) {
          a && (a.xAxis && c.xAxis[0] && a.xAxis.type === c.xAxis[0].options.type && delete a.xAxis,
            c.update(a, b, !0))
        }, x(!0, d.data, a), d.data && d.data.googleSpreadsheetKey && !a.columns && delete d.data.columns, this.init(d.data))
      }
    }
    B(a, "init", function(a) {
      const b = this,
      ...
      var f = d().data;
      let e = a.args[0] || {};
      (f || e && e.data) && !b.hasDataDef && (b.hasDataDef = !0, f = x(f, e.data), b.data = new D(M(f, {
        afterComplete: function(a) {
          let d, f;
          if (Object.hasOwnProperty.call(e, "series"))
            if ("object" === typeof e.series)
              for (d = Math.max(e.series.length, a && a.series ? a.series.length : 0); d--;) f = e.series[d] || {}, e.series[d] = x(f, a && a.series ?
                a.series[d] : {});
    ...
    class K {
      ...
      read(a, b) {
        ...
        this.readers.forEach(e => {
          ...
          c ? d.push(f) : 0 < e.configName.indexOf(".") ? v.prototype.setNestedProperty(d,
            f, e.configName) : d[e.configName] = f
        });
        if ("undefined" === typeof this.name && 2 <= this.readers.length) {
          ...
          2 <= b.length && (b.shift(), b.sort(function(a, b) {
            return a - b
      ...
      getReferencedColumnIndexes() {
        const a = [];
        let b, c;
        for (b = 0; b < this.readers.length; b += 1) c = this.readers[b], "undefined" !== typeof c.columnIndex && a.push(c.columnIndex);
        return a
      }
      hasReader(a) {
        let b, c;
